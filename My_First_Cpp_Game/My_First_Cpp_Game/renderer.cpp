...
internal void
draw_score(int number, float x, float y, float size, u32 color) {
	...
	do {
		...
		case 1:
			...
			break;
		case 2:
			draw_rect(x, y + size * 2.f, half_size * 3.f, half_size, color);
			draw_rect(x + size, y + size, half_size, half_size, color);
			draw_rect(x, y, half_size * 3.f, half_size, color);
			draw_rect(x - size, y - size, half_size, half_size, color);
			draw_rect(x, y - size * 2.f, half_size * 3.f, half_size, color);
			x -= size * 4.f;
			break;
		...
		case 4:
			draw_rect(x + size, y, half_size, size * 2.5f, color);
			draw_rect(x, y, half_size, half_size, color);
			draw_rect(x - size, y + size, half_size, half_size * 3.f, color);
			x -= size * 4.f;
			break;
		case 5:
			draw_rect(x, y + size * 2.f, half_size * 3.f, half_size, color);
